...
class AlphaBetaAgent(MultiAgentSearchAgent):
    ...
    def getAction(self, gameState):
        ...
        def alphabeta(state):
            ...
            value = []
            for action in state.getLegalActions(0):
                #actionValue, alpha0, beta0  = minValue(state.generateSuccessor(0, action), 1, 0, alpha, beta)
...
class ExpectimaxAgent(MultiAgentSearchAgent):
    ...
    def getAction(self, gameState):
        ...
        def minValue(state, agentIdx, depth):
            ...
            return sum * 1.0 / len(state.getLegalActions(agentIdx))
...
def betterEvaluationFunction(currentGameState):
    ...
    # stop = (direction == Directions.STOP)
    state_score = currentGameState.getScore()

    return -2 * closestFood + ghost_distance - 4 * len(foodList) - 5 * closestCapsule + 8 * state_score
